...
namespace Willow.Tests
{
    ...
    public class ProgramTests
    {
        ...
        public async Task Should_Return_Expected_Result_For_Solution_Not_Specifying_Framework()
        {
            // Given
            var fixture = new Fixture();
            var solution = Fixture.GetPath("Willow.Tests.Fixtures.sln");
        ...
        public sealed class Fixture
        {
            public static string GetPath(string path)
            {
                ...
                var solutionDirectory = Path.GetFullPath(Path.Combine(workingDirectory, "../../../../Willow.Tests.Fixtures"));
        ...
        public async Task Should_Return_Expected_Result_For_Slnx_Solution()
        {
            // Given
            var fixture = new Fixture();
            var solution = Fixture.GetPath("Willow.Tests.Fixtures.slnx");
